...
export default {
    ...
    <section class="login-signup">
        ...
        <form  @submit.prevent="login">
            ...
            <input type="password" v-model="credentials.password" placeholder="Password" autocomplete="current-password" />
            <button>Login</button>
        </form>
        <hr />
        <form  @submit.prevent="signup">
            ...
            <input type="password" v-model="signupInfo.password" placeholder="Password" autocomplete="current-password" />
